...
TESTS = [
    ...
    ("test_task_lifecycle", ROOT / "tests" / "sim" / "test_task_lifecycle.c"),
    ("test_task_stack_top", ROOT / "tests" / "sim" / "test_task_stack_top.c"),
    ...
    ("test_sync_dynamic_allocation", ROOT / "tests" / "coupling" / "test_sync_dynamic_allocation.c"),
    ...
    ("test_event_timer_dynamic_allocation", ROOT / "tests" / "coupling" / "test_event_timer_dynamic_allocation.c"),
    ...
    ("test_buffer_dynamic_allocation", ROOT / "tests" / "coupling" / "test_buffer_dynamic_allocation.c"),
