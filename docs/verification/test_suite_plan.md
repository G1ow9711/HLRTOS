...
| `tests/coupling/` | 跨模块耦合测试 | 矩阵 `C-001` 到 `C-027` |
...
| 缓冲 | `tests/unit/test_stream_buffer_*.c`、`tests/unit/test_message_buffer_*.c` | `C-020` 到 `C-022` |
| 内存 | `tests/unit/test_heap_*.c` | `C-023` 到 `C-024` |
| trace/断言 | `tests/unit/test_trace_*.c`、`tests/port_mock/test_assert_context_*.c` | `C-025` 到 `C-027` |
| STM32 端口 | `tests/port_mock/test_port_stm32_*.c` | `C-028` 到 `C-029` |
